(function buildRuleData() {
  ...
  var EXACT_RULES = Object.freeze([
    ...
    group("exact/extrapolated", [
      ...
      pattern`[fucking] alien`,
      pattern`[fucking] chance`,
      pattern`[fucking] do this`,
      pattern`[fucking] dumbass`,
      pattern`[fucking] hack`,
      pattern`[shit] in his`,
      pattern`[shit] in our`,
      pattern`[shit] in their`,
      pattern`[fuck] it to`,
      pattern`[fuck] it. they`,
      pattern`[fuck] it. we`,
      pattern`[fucking] legend`,
      pattern`[fuck] me for`,
      pattern`[fuck] me money`,
      pattern`[fucking] sex`,
      pattern`[shit] so he`,
      pattern`[shit] so we`,
      pattern`[shit] their pants`,
      pattern`[shit] they want to`,
      pattern`[fucked] up you`,
      pattern`[fuck] yeah we`,
      pattern`[shit] you've`,
      pattern`a [fucking] take`,
      pattern`a [shit] there`,
      pattern`a [shit] they`,
      pattern`a [shit] why`,
      pattern`ah [shit] as`,
      pattern`ah [fuck] me`,
      pattern`ah [shit] that`,
      pattern`ah [shit] you're`,
      pattern`and he [fucking]`,
      pattern`and she [fucking]`,
      pattern`blowing [shit]`,
      pattern`crazy [shit] but`,
      pattern`crazy [shit] happened`,
      pattern`crazy [shit] I`,
      pattern`crazy [shit] I've`,
      pattern`crazy [shit] in`,
      pattern`crazy [shit] like`,
      pattern`crazy [shit] so`,
      pattern`for this [shit] and`,
      pattern`for this [shit] my`,
      pattern`for this [shit] there`,
      pattern`for this [shit] you`,
      pattern`gets [fucked] over`,
      pattern`give a [shit] and`,
      pattern`give a [shit] but`,
      pattern`give a [shit] get`,
      pattern`give a [shit] is`,
      pattern`give a [shit] the`,
      pattern`give a [shit] you're`,
      pattern`hey [fuck] it`,
      pattern`I'd [fuck]`,
      pattern`it's his [fucking]`,
      pattern`it's your [fucking]`,
      pattern`just [fucked] in the`,
      pattern`just [fucked] me`,
      pattern`lot of [shit] but`,
      pattern`lot of [shit] from`,
      pattern`lot of [shit] going on`,
      pattern`lot of [shit] happened`,
      pattern`lot of [shit] I`,
      pattern`lot of [shit] in the`,
      pattern`lot of [shit] on`,
      pattern`lot of [shit] that`,
      pattern`lot of [shit] yeah`,
      pattern`make some [fucking]`,
      pattern`making that [shit]`,
      pattern`me me [fucking]`,
      pattern`mean [shit] the`,
      pattern`mean [shit] you`,
      pattern`nature [shit]`,
      pattern`need a [fucking]`,
      pattern`no [shit] the`,
      pattern`no [shit] to`,
      pattern`no [shit] we`,
      pattern`no [shit] yeah`,
      pattern`of [shit] at`,
      pattern`of [shit] I've`,
      pattern`of [shit] is`,
      pattern`of [shit] it's`,
      pattern`of [shit] like`,
      pattern`of [fucked] me up`,
      pattern`of [shit] so`,
      pattern`of [shit] together`,
      pattern`of [shit] we`,
      pattern`of [shit] you're`,
      pattern`of [shit] your`,
      pattern`oh [shit] a`,
      ...
      pattern`some [shit] he`,
      pattern`some [shit] she`,
      pattern`some [shit] this`,
      pattern`stole his [shit]`,
      pattern`that [shit] ain't`,
      pattern`that [shit] goes`,
      pattern`that [shit] I'm`,
      pattern`that [shit] too`,
      pattern`the [shit] that they`,
      pattern`the [shit] that we`,
      pattern`the [shit] that you`,
      pattern`the [fuck] they want`,
      pattern`then [fuck] it`,
      pattern`this [shit] as`,
      pattern`this [shit] hurts`,
      pattern`this [shit] isn't`,
      pattern`this [shit] to`,
      pattern`this [shit] yeah`,
      pattern`throw [shit]`,
      pattern`to [fucking] stop`,
      pattern`to do [shit] and`,
      pattern`to do [shit] in`,
      pattern`to do [shit] now`,
      pattern`uh [fuck] me`,
      pattern`well [shit] like`,
      pattern`well [shit] that`,
      pattern`what they [fucking]`,
      pattern`where the [fuck] he`,
      pattern`where's our [fucking]`,
      pattern`whole bunch of [shit]`,
      pattern`will [shit] all`,
      pattern`will [shit] down`,
      pattern`will [shit] I`,
      ...
      pattern`ah [fuck] i'm`,
      pattern`ah [fuck] oh`,
      pattern`ah [fuck] okay`,
      pattern`ah [fuck] yeah`,
      pattern`ah [fuck] you`,
      pattern`and [shit] every`,
      pattern`and [shit] for`,
      pattern`and [shit] I'm`,
      pattern`and [shit] if`,
      pattern`and [shit] just`,
      pattern`and [shit] oh`,
      pattern`and [shit] right`,
      pattern`and [shit] she`,
      pattern`and [shit] went`,
      pattern`are [fucking] kill`,
      pattern`are the [fucking]`,
      pattern`because [fuck] i`,
      pattern`because [fuck] that`,
      pattern`because [fuck] them`,
      pattern`because [fuck] this`,
      pattern`because [fuck] you`,
      pattern`but [shit] happens`,
      pattern`but [fuck] i'm`,
      pattern`but [fuck] them`,
      pattern`but [fuck] those`,
      pattern`but [fuck] you`,
      pattern`but she [fucking]`,
      pattern`deep [shit] you`,
      pattern`do the [fucking]`,
      pattern`doing [shit] so`,
      pattern`doing a [fucking]`,
      pattern`don't [fuck] i`,
      pattern`don't [fuck] my`,
      pattern`don't [fuck] over`,
      pattern`don't [fucking] tell`,
      pattern`don't give a [shit] if`,
      pattern`don't give a [shit] in`,
      pattern`even the [fucking]`,
      pattern`get [shit] off`,
      pattern`go [fuck] it`,
      pattern`go [fuck] me`,
      pattern`go [fuck] no`,
      pattern`have [shit] on`,
      pattern`have [shit] ton`,
      pattern`her [shit] i`,
      pattern`her [shit] the`,
      pattern`him [fuck] yeah`,
      pattern`his [shit] get`,
      pattern`his [shit] I'm`,
      pattern`his [shit] to`,
      pattern`his [shit] was`,
      pattern`if you [fuck] it`,
      pattern`if you [fuck] with`,
      pattern`is [fucking] with`,
      pattern`like [fuck] it's`,
      pattern`like [fuck] my`,
      pattern`like [fuck] no`,
      pattern`like [fuck] the`,
      pattern`like [fuck] this`,
      pattern`like [fuck] what`,
      pattern`like [fuck] yeah`,
      pattern`like [fuck] your`,
      pattern`like absolute [shit] i`,
      pattern`like absolute [shit] what`,
      pattern`looks like some [fucking]`,
      pattern`losing their [shit] now`,
      pattern`losing their [shit] so`,
      pattern`losing their [shit] their`,
      pattern`losing their [shit] yeah`,
      pattern`lot of [shit] well`,
      pattern`make a [fucking]`,
      pattern`man [fuck] a`,
      pattern`man [fuck] all`,
      pattern`man [fuck] them`,
      pattern`much [shit] happened`,
      pattern`much [shit] i`,
      pattern`much [shit] in`,
      pattern`much [shit] is`,
      pattern`much [shit] oh`,
      pattern`much [shit] on`,
      pattern`much [shit] that`,
      pattern`much [shit] to do`,
      pattern`my [fucking] rock`,
      pattern`my [fucking] son`,
      ...
      pattern`oh [fuck] to`,
      pattern`okay [fuck] it`,
      pattern`okay [fuck] the`,
      pattern`okay [fuck] this`,
      pattern`okay [fuck] you`,
      pattern`okay [fuck] your`,
      pattern`one [fuck] that`,
      pattern`one [fuck] you`,
      pattern`or [shit] i`,
      pattern`other [shit] but`,
      pattern`other [shit] going`,
      pattern`other [shit] like`,
      pattern`other [shit] that you`,
      pattern`other [shit] to`,
      pattern`other [shit] we`,
      pattern`other [shit] you`,
      pattern`put the [fucking]`,
      pattern`same [shit] it's`,
      pattern`same [shit] right`,
      pattern`same [shit] we`,
      pattern`same [shit] you`,
      pattern`say [fuck] the`,
      pattern`some stupid [shit] too`,
      pattern`take any [shit]`,
      pattern`that [shit] for`,
      pattern`that [shit] or`,
      ...
      pattern`their [shit] and`,
      pattern`their [shit] as`,
      pattern`their [shit] i`,
      pattern`their [shit] is`,
      pattern`their [shit] out`,
      pattern`their [shit] what`,
      pattern`then [fuck] a`,
      pattern`they [shit] was`,
      pattern`this [fucking] rock`,
      pattern`to [shit] I'm`,
      pattern`to [shit] so`,
      pattern`to [shit] they`,
      pattern`tough [shit] going`,
      pattern`tough [shit] the`,
      pattern`want the [fucking]`,
      pattern`want to [fuck] my`,
      pattern`was [fucking] get`,
      pattern`where the [fuck] i'm going`,
      pattern`you [fucking] ass`,
      pattern`you [fucking] good`,
      pattern`you just [fucking] with me`,
      pattern`you sick [fuck] you`,
      pattern`you sick [fuck] your`,
      pattern`your [shit] again`,
      pattern`your [shit] i`,
      pattern`your [shit] out`,
      pattern`your [shit] yeah`,
      pattern`your [shit] you're`,
      pattern`ah [shit] he`,
      pattern`and [shit] ah`,
      pattern`and [shit] uh`,
      pattern`at this [shit] every`,
      pattern`at this [shit] I`,
      pattern`at this [shit] right`,
      pattern`at this [shit] she`,
      pattern`at this [shit] the`,
      pattern`at this [shit] this`,
      pattern`bunch of [shit] in`,
      pattern`but [shit] all`,
      pattern`but [shit] is`,
      pattern`but [shit] it's`,
      pattern`can [fuck] all`,
      pattern`can [fuck] oh`,
      pattern`don't [fuck] we`,
      pattern`dumb [shit] i'm`,
      pattern`dumb [shit] so`,
      pattern`eat [shit] get`,
      pattern`eat [shit] i'm`,
      pattern`give a [fuck] all`,
      pattern`give a [fuck] i'm`,
      pattern`give a [fuck] yeah`,
      pattern`give a [fuck] your`,
      pattern`have a [shit] for`,
      pattern`I'll [fuck] you`,
      pattern`a [fuck] your`,
      pattern`oh [shit] we're`,
      pattern`oh [shit] they're`,
      pattern`that [shit] the`,
      pattern`this [shit] it's`,
      pattern`oh [shit] she's`,
      pattern`? [fuck] we`,
      pattern`I'm [fucking] god`,
      pattern`jack [shit] here`,
      pattern`jack [shit] so`,
      pattern`jack [shit] um`,
      pattern`kind of [shit] I`,
      pattern`kind of [shit] she`,
      pattern`like oh [shit] here`,
      pattern`like oh [shit] now`,
      pattern`like oh [shit] yeah`,
      pattern`make the [fucking]`,
      pattern`of that [shit] it's`,
      pattern`of that [shit] the`,
      pattern`of that [shit] why`,
      pattern`of this [shit] again`,
      pattern`of this [shit] all`,
      pattern`of this [shit] from`,
      pattern`of this [shit] is`,
      pattern`of this [shit] it's`,
      pattern`of this [shit] off`,
      pattern`of this [shit] she`,
      pattern`oh [shit] from`,
      pattern`oh [shit] in`,
      pattern`oh [shit] just`,
      pattern`oh [shit] right`,
      pattern`oh [shit] you know`,
      pattern`oh [shit] you're`,
      pattern`oh [shit] your`,
      pattern`or [shit] if`,
      pattern`or [shit] what`,
      pattern`own [shit] and`,
      pattern`own [shit] in`,
      pattern`own [shit] right`,
      pattern`right [fucking] get`,
      pattern`right [fuck] it`,
      pattern`right [fuck] me`,
      pattern`right [fuck] no`,
      pattern`right [fuck] well`,
      pattern`said [fuck] all`,
      pattern`say [shit] I`,
      pattern`say [shit] if`,
      pattern`say [shit] out`,
      pattern`so [fuck] that`,
      pattern`so [fuck] the`,
      pattern`so [fuck] them`,
      pattern`so [fuck] well`,
      pattern`stupid [shit] but`,
      pattern`stupid [shit] ever`,
      pattern`stupid [shit] up`,
      pattern`the [fuck] them`,
      pattern`well [fuck] my`,
      pattern`well [fuck] off`,
      pattern`well [fuck] them`,
      pattern`where the [fuck] i'm`,
      pattern`write this [shit] I`,
      pattern`you [fuck] you guys`,
      pattern`you [fuck] you think`,
